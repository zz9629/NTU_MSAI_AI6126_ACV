...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            lq_folder='FFHQ/train/GT',
            gt_folder='FFHQ/train/GT',
            pipeline=train_pipeline,
            scale=scale)),
    val=dict(
        type=val_dataset_type,
        lq_folder='FFHQ/val/LQ',
        gt_folder='FFHQ/val/GT',
        pipeline=test_pipeline,
        scale=scale,
        filename_tmpl='{}'),
    test=dict(
        type=val_dataset_type,
        lq_folder='FFHQ/test/LQ',
        gt_folder='FFHQ/val/GT',
        pipeline=test_pipeline,
        scale=scale,
        filename_tmpl='{}'))
