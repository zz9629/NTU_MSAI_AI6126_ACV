...
│   ├── main.py	      ## The code of training and inferencing using exsiting checkpoint and config file.
│   ├── srresnet_ffhq_400k.py     ## The config of my model
│   └── training.log.json		## training log files
